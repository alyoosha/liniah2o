...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-field-additional-images', __webpack_require__(3));
  Vue.component('detail-field-additional-images', __webpack_require__(6));
  Vue.component('form-field-additional-images', __webpack_require__(14));
});
...
// module
exports.push([module.i, "\n.wrap[data-v-0224618e] {\n    display: -webkit-box;\n    display: -ms-flexbox;\n    display: flex;\n    -ms-flex-wrap: wrap;\n        flex-wrap: wrap;\n    height: 100%;\n}\n.card[data-v-0224618e] {\n    display: -webkit-box;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-box-align: center;\n        -ms-flex-align: center;\n            align-items: center;\n    max-width: 320px;\n    margin-right: 10px;\n    margin-bottom: 10px;\n    -webkit-box-flex: 1;\n        -ms-flex: 1 1 100%;\n            flex: 1 1 100%;\n    -ms-flex-item-align: stretch;\n        align-self: stretch\n}\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        removeImage: function removeImage(event) {
            var path = event.target.src.split('/').reverse()[0];
            event.target.insertAdjacentHTML('afterend', '<p style="font-size: 18px; margin: 5% 2%; text-align: center">Изображение отсутствует: ' + '<b>' + path + '</b>' + '</p>');
            event.target.remove();
        }
    }
});
                  ...
                  return _c(
                    ...
                    [
                      _c("img", {
                        ...
                        attrs: { src: _vm.path + image, draggable: "false" },
                        on: {
