...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-field-multiselect', __webpack_require__(3));
  Vue.component('detail-field-multiselect', __webpack_require__(6));
  Vue.component('form-field-multiselect', __webpack_require__(14));
});
...
// module
exports.push([module.i, "\n.list[data-v-0224618e] {\n    padding: 0;\n    list-style-type: none;\n}\n.item[data-v-0224618e] {\n    padding: 5px 10px;\n}\n.item[data-v-0224618e]:not(last-child) {\n    margin-bottom: 10px;\n}\n.wrap-style[data-v-0224618e] {\n    border-radius: 5px;\n    background-color: rgb(65, 184, 131);\n    padding: 5px 8px;\n    color: white;\n}\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    beforeMount: function beforeMount() {
        ...
        this.value = this.field.value.tags;
    }
});
            ...
            ? _c(
                ...
                _vm._l(_vm.value, function(v) {
                  return _c("li", { staticClass: "item" }, [
                    _c("span", { staticClass: "wrap-style" }, [
                      _vm._v(_vm._s(v.name_ru))
                    ])
                  ])
                }),
                0
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    beforeMount: function beforeMount() {
        var itemsAll = this.field.value.itemsAll;
        var itemsSelected = this.field.value.items;
        ...
        if (itemsSelected.length > 0) {
            if (this.field.value.group) {
                ...
                try {
                    for (var _iterator = itemsAll[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        ...
                        try {
                            for (var _iterator2 = itemsSelected[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                                var i = _step2.value;
                ...
                try {
                    for (var _iterator4 = itemsAll[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                        ...
                        try {
                            for (var _iterator5 = itemsSelected[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                                var _i = _step5.value;

                                if (_item['id'] == _i['id']) {
                                    this.valuesEnd.push(_i.id);
                                    this.values.push(_i);
                                }
                            }
                        } catch (err) {
    ...
    methods: {
        ...
        removeValue: function removeValue(event) {
            for (var v in this.valuesEnd) {
                if (this.valuesEnd[v] == event.id) {
                    this.valuesEnd.splice(v, 1);
                }
            }
        },
        setValueTagsEnd: function setValueTagsEnd(data) {
            return data.join(',');
        },
        setValueFeaturesEnd: function setValueFeaturesEnd(data) {
