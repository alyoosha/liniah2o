                                ...
                                <div v-if="key !== 'category_info'" class="product-card" tabindex="0">
                                    <div class="product-card__content">
                                        ...
                                        <div class="product-card__footer">
                                            ...
                                            <div v-if="product[0].complements" class="product-card__controls" :class="{dnone: isInCartKit(product[0].articul) || !product[0].in_stock}">
                                                <button
                                                    class="btn product-card__btn product-card__btn_order btn_flex js-to-order"
                                                    type="button"
                                                ...
                                                >
                                                    ...
                                                    <span class="btn__text section__title">{{ __('add_to_order') }}</span>
                                                </button>
                                            </div>
                                            <div v-else class="product-card__controls" :class="{dnone: isInCart(product[0].articul) || !product[0].in_stock}">
                                                <button
                                                    class="btn product-card__btn product-card__btn_order btn_flex js-to-order"
                                                    type="button"
                                                    :aria-label="__('add_to_cart')"
...
<script>
    ...
    export default {
        ...
        computed: {
            slider() {
                return $('.js-product-slider').length;
            }
        },
        mounted() {
